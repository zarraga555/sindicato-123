        ...
        <fieldset class="border border-gray-300 rounded-md p-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    @error('driver_partner') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                <!-- Name (span 2 columns) -->
        ...
        <fieldset class="border border-gray-300 rounded-md p-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    @error('loan_start_date') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                <!-- Payment frecuency -->
                <div>
                    <div class="mb-4">
                ...
                <div>
                    ...
                    <div
                        ...
                        <input
                            class="fi-input block w-full border-none py-1.5 text-base text-gray-950 transition duration-75 placeholder:text-gray-400 focus:ring-0 disabled:text-gray-500 dark:text-white dark:placeholder:text-gray-500 sm:text-sm sm:leading-6 bg-transparent ps-3 pe-3"
                            id="numberInstalments"
                            type="number"
                            wire:model.live="numberInstalments">
                    </div>
                    @error('numberInstalments') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                <!-- Loan amount -->
                <div>
                    ...
                    @error('amountLoan') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
                <!-- Interest rate -->
                <div>
                    <label class="block text-sm font-medium leading-6 text-gray-950 dark:text-white"
                ...
                <div>
                    ...
                    <div
                        ...
                        <input
                            ...
                            step="0.01"
                            onblur="formatDecimals(this)"
                            wire:model.live="total_debt"
                            readonly
                            disabled>
                    </div>
                    @error('total_debt') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
            </div>
        </fieldset>
