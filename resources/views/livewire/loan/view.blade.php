...
<div>
    <section class="flex flex-col gap-y-8 py-8 mt-14">
        <x-breadcrumb pageTitle="{{ __('messages.loan_of', ['vehicle' => $this->loan->vehicle_id]) }}"
            breadcrumbMainUrl="{{ route('loans.index') }}" breadcrumbMain="{{ __('Loans') }}"
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <div class="mt-1 text-gray-900 dark:text-gray-200">
                    {{ $this->loan->interest_payment_method === 'separate'
                        ? __('Charge in a separate installment')
