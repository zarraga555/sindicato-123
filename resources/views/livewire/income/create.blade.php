            ...
            <div class="fi-form-actions mt-4">
                ...
                "
                    ...
                    <div class="flex gap-3">
                        ...
                        <button
                            wire:loading.attr="disabled"
                            wire:click="payWithQRAndCreateAnother"
                        ...
                        >
                            <span class="fi-btn-label">Pagar con QR y crear otro</span>
                        </button>

                        <!-- Botón Guardar Pago Pendiente y Crear Otro -->
                        <button
                            wire:loading.attr="disabled"
                            wire:click="savePendingPaymentAndCreateAnother"
                        ...
                        >
                            <span class="fi-btn-label">Guardar pago pendiente y crear otro</span>
                        </button>
                    </div>
                </div>
            </div>
