...
<div>
    <section class="flex flex-col gap-y-8 py-8 mt-14">
        <x-breadcrumb pageTitle="{{ __('Collaterals') }}" breadcrumbMainUrl="{{ route('collateral.index') }}"
            breadcrumbMain="{{ __('Collaterals') }}" breadcrumbCurrent="{{ __('List') }}">
            @can('crear prestamos')
                <!-- Contenido dentro del slot, como el botón de creación -->
                <a href="{{ route('collateral.create') }}"
