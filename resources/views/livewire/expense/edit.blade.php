...
<div>
    <section class="flex flex-col gap-y-8 py-8 mt-14">
        <x-breadcrumb pageTitle="Editar Egreso ({{ $nameLabel }})" breadcrumbMainUrl="{{ route('expense.index') }}"
            breadcrumbMain="Egresos	" breadcrumbCurrent="Editar">
            @can('eliminar egreso')
