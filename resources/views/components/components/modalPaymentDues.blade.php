<x-dialog-modal wire:model="showPaymentModal">
    ...
    <x-slot name="content">
        ...
        <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50" role="alert">
            ...
            <p><strong>Cuota pendiente:</strong>Nro:{{$instalmentNumber}} : {{ $currency }}. {{ $pendingAmount }} </p>
        ...
        <div class="mb-4">
            ...
            <x-input type="number" id="amount_paid" wire:model="amount_paid"
                     class="w-full border-gray-300 focus:border-blue-500 @error('amount_paid') border-red-500 @enderror"
                     step="0.01" required/>
